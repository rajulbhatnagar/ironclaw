...
SEL = {
    ...
    "job_pending_badge":        "#jobs-tbody .job-row .job-pending-badge",
    "job_pending_gates":        "#job-pending-gates",
    "job_pending_gate_card":    "#job-pending-gates .approval-card",
    "job_pending_approve":      "#job-pending-gates .approval-actions button.approve",
    "job_pending_deny":         "#job-pending-gates .approval-actions button.deny",
